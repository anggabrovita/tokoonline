...
$table .='<tr>
        ...
        <th style="border:1px solid #000;">Bergabung Sejak</th>
         </tr>';
$no = 1;
...
$table .='<tr>
        ...
        <td style="border:1px solid #000;">'.$row->telepon.'</td>
        <td style="border:1px solid #000;">'.date('d-m-Y', $row->tanggal_daftar).'</td>
    </tr>';
}
$table .='</table>';
...
$pdf->MultiCell(55, 5, $txt, 0, 'J', 0, 2, 140, 140, true);
...
ob_clean();
$pdf->Output('Laporan Data Pelanggan', 'I');
